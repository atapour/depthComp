...
Mat DepthFill::preProcess(Mat depthIn, const Mat& labelRszd){
...
void DepthFill::writeImg(const String& imgName, const String& sufix, const Mat& mat)
{
	assert(!mat.empty());
...
Mat DepthFill::identFillHoles(Mat depthIn, const Mat& labelRszd){
